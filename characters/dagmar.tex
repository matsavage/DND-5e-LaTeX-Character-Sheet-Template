...
\AddWeapon{Stiletto Dagger}{}{1d3 p}

\AttacksSpellcasting{
\textbf{Arcane Focus:}\\A glass orb filled with moving smoke, known as Dagmar

\textbf{Stiletto Dagger:}\\Advantage on stealth 

\textbf{Draconic Ancestry:}\\Ice Damage Resistance

\textbf{Ring of Fire Resistance:}\\Fire Damage Resistance
}
...
\SecondLevelSpellSlotB{Misty Step (V)}
\SecondLevelSpellSlotC{Scorching Ray (V, S)}
\SecondLevelSpellSlotD{Web (V, S, M (a bit of spiderweb) (Wand of Web)}
