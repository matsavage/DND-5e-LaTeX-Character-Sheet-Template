...
\begin{DndTable}{Xll}
\tiny \textcolor{terciary-indicator-color}{\textsf{NAME}}        &
\tiny \textcolor{terciary-indicator-color}{\textsf{ATK BONUS}}   & 
\tiny \textcolor{terciary-indicator-color}{\textsf{DAMAGE/TYPE}}
\WeaponsHeld
\end{DndTable}
